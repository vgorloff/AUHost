...
public extension ColorType {
   ...
   convenience init(hexValue hex: UInt64) {
   ...
   convenience init?(rgba: String, rgbCompomentsIn256Range: Bool = false) {
      var rgbaValue = rgba.trimmingCharacters(in: .whitespacesAndNewlines)
