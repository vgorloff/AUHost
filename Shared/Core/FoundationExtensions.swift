...
public extension DispatchQueue {
    ...
    public static var Default: DispatchQueue =  .global(qos: .default)
    public static var UserInteractive: DispatchQueue = .global(qos: .userInteractive)
    public static var UserInitiated: DispatchQueue = .global(qos: .userInitiated)
    public static var Utility: DispatchQueue = .global(qos: .utility)
