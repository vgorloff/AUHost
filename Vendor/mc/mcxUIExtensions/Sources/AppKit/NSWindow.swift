...
extension NSWindow {
   ...
   public convenience init(contentRect: NSRect, styleMask style: NSWindow.StyleMask) {
      self.init(contentRect: contentRect, styleMask: style, backing: .buffered, defer: true)
   ...
   public convenience init(contentRect: CGRect, style: Style) {
      ...
      case .default:
         ...
         self.init(contentRect: contentRect, styleMask: styleMask)
      }
   }
