...
// ID: 67604B4E-6797-4994-8552-65AD41970D20
...
public struct Logger {
	...
	public func logInit(function: String = __FUNCTION__, file: String = __FILE__, line: Int32 = __LINE__) {
	...
	public func logDeinit(function: String = __FUNCTION__, file: String = __FILE__, line: Int32 = __LINE__) {
		guard Logger.sharedLoggerProperties.logMessageFilter.value.shouldLogInitDeinitMethods else {
			return
		}
		Logger.logMessage("{~~~}", level: .Verbose, context: loggerProperties.context, function: function, file: file, line: line,
	...
	// MARK: -
	public func logErrorIf<T>(@autoclosure expression: () -> BooleanType, _ message: T, function: String = __FUNCTION__,
		file: String = __FILE__, line: Int32 = __LINE__) {
	...
	public func logWarnIf<T>(@autoclosure expression: () -> BooleanType, _ message: T, function: String = __FUNCTION__,
		file: String = __FILE__, line: Int32 = __LINE__) {
		guard Logger.sharedLoggerProperties.logMessageFilter.value.shouldLogMessage && expression().boolValue else {
			return
		}
	...
	public func logInfoIf<T>(@autoclosure expression: () -> BooleanType, _ message: T, function: String = __FUNCTION__,
		file: String = __FILE__, line: Int32 = __LINE__) {
		guard Logger.sharedLoggerProperties.logMessageFilter.value.shouldLogMessage && expression().boolValue else {
			return
		}
	...
	public func logDebugIf<T>(@autoclosure expression: () -> BooleanType, _ message: T, function: String = __FUNCTION__,
		file: String = __FILE__, line: Int32 = __LINE__) {
		guard Logger.sharedLoggerProperties.logMessageFilter.value.shouldLogMessage && expression().boolValue else {
			return
		}
	...
	public func logVerboseIf<T>(@autoclosure expression: () -> BooleanType, _ message: T, function: String = __FUNCTION__,
		file: String = __FILE__, line: Int32 = __LINE__) {
		guard Logger.sharedLoggerProperties.logMessageFilter.value.shouldLogMessage && expression().boolValue else {
			return
		}
