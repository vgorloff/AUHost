...
class MainMenu: NSMenu {
   ...
   lazy var menuAUHostItem01AboutAUHost = NSMenuItem(title: "About AUHost", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
   lazy var menuAUHostItem02Separator = NSMenuItem.separator()
   lazy var menuAUHostItem03Preferences = NSMenuItem(title: "Preferences…", action: nil, keyEquivalent: ",")
   lazy var menuAUHostItem04Separator = NSMenuItem.separator()
   lazy var menuAUHostItem05Services = NSMenuItem(title: "Services", action: nil, keyEquivalent: "")
   lazy var menuAUHostItem06Separator = NSMenuItem.separator()
   lazy var menuAUHostItem07HideAUHost = NSMenuItem(title: "Hide AUHost", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h")
   lazy var menuAUHostItem08HideOthers = NSMenuItem(title: "Hide Others", action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
   lazy var menuAUHostItem09ShowAll = NSMenuItem(title: "Show All", action: #selector(NSApplication.unhideAllApplications(_:)), keyEquivalent: "")
   lazy var menuAUHostItem10Separator = NSMenuItem.separator()
   lazy var menuAUHostItem11QuitAUHost = NSMenuItem(title: "Quit AUHost", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
   lazy var menuAUHost = NSMenu(title: "AUHost")
   ...
   lazy var menuHelpItemAUHostHelp = NSMenuItem(title: "AUHost Help", action: #selector(NSApplication.showHelp(_:)), keyEquivalent: "?")
   lazy var menuHelp = NSMenu(title: "Help")
   lazy var menuMainMenuItemAUHost = NSMenuItem(title: "AUHost", action: nil, keyEquivalent: "")
   ...
   private func setupUI() {
      ...
      addItem(menuMainMenuItemAUHost)
      ...
      menuHelp.addItem(menuHelpItemAUHostHelp)
      ...
      menuMainMenuItemAUHost.submenu = menuAUHost

      menuAUHost.addItem(menuAUHostItem01AboutAUHost)
      menuAUHost.addItem(menuAUHostItem02Separator)
      menuAUHost.addItem(menuAUHostItem03Preferences)
      menuAUHost.addItem(menuAUHostItem04Separator)
      menuAUHost.addItem(menuAUHostItem05Services)
      menuAUHost.addItem(menuAUHostItem06Separator)
      menuAUHost.addItem(menuAUHostItem07HideAUHost)
      menuAUHost.addItem(menuAUHostItem08HideOthers)
      menuAUHost.addItem(menuAUHostItem09ShowAll)
      menuAUHost.addItem(menuAUHostItem10Separator)
      menuAUHost.addItem(menuAUHostItem11QuitAUHost)

      menuAUHostItem08HideOthers.keyEquivalentModifierMask = [.option, .command]
